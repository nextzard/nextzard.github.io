...
2. [https://www.nerdfonts.com/](https://www.nerdfonts.com)
3. 원하는 폰트 다운 -> Downloads 이동 -> 실행 -> 설치
4. 내 경우 : MesloLG Nerd Font, JetBrainsMono, SouceCodePro
...
- App Center 검색 안됨. 
* Ubuntu에서는 새로운 앱 센터는 스냅 및 deb 패키지 형식을 모두 지원
...
3. 코드 복사 -> [https://ubuntu.com/pro/attach](https://ubuntu.com/pro/attach)  로그인   
